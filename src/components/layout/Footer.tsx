...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-zinc-900/50 text-gray-400 p-4 text-center mt-auto">
      ...
      {/* Open Source Section */}
      <div className="bg-gradient-to-r from-[rgba(59,130,246,0.06)] to-[rgba(147,51,234,0.06)] px-2 sm:px-3 py-1.5 rounded border border-[rgba(59,130,246,0.15)] mb-2 max-w-sm mx-auto">
      ...
      <div className="bg-gradient-to-r from-[rgba(255,107,107,0.06)] to-[rgba(255,142,83,0.06)] px-2 sm:px-3 py-1.5 rounded border border-[rgba(255,107,107,0.15)] max-w-sm mx-auto mb-3">
        <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-[0.625rem] sm:text-xs">
          <a 
